        ...
        <>
          <Section title="Firmendaten">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Field label="Name"><input type="text" placeholder="Musterfirma" value={config.company.name} onChange={(e) => setCompany("name", e.target.value)} /></Field>
              <Field label="Tagline"><input type="text" placeholder="Deine Tagline hier" value={config.company.tagline} onChange={(e) => setCompany("tagline", e.target.value)} /></Field>
            </div>
            <div className="grid sm:grid-cols-2 gap-4">
